...
<div class="container">
    <div class="row text-center">
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="<?php echo e(asset('assets/Farhana Akther Runa.jpg')); ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Farhana Akther Runa</h5>
            </div>
        </div><!-- End -->
        <!-- Team item -->
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="<?php echo e(asset('assets/A K M Musfiquzzaman.jpg')); ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">A K M Musfiquzzaman</h5>
            </div>
        </div><!-- End -->
        <!-- Team item -->
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="<?php echo e(asset('assets/Md. Kamrul Hasan Tanvir Bhuiyan.jpg')); ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Md. Kamrul Hasan</h5>
            </div>
        </div><!-- End -->
        <!-- Team item -->
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="<?php echo e(asset('assets/Md. Tarak Hossain.jpg')); ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Md. Tarak Hossain</h5>
            </div>
        </div><!-- End -->
    </div>
</div>
...
<?php /**PATH X:\xampp\htdocs\nubmart\core\resources\views/master/front.blade.php ENDPATH**/ ?>